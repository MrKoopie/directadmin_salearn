#!/bin/bash
# @description	Installs the spamassassin sa-learn scripts for a new created DirectAdmin account.
...
# Run the scripts
create_teach_folders "/home/$username/Maildir" $username;
create_teachspam_folder_for_every_domain_of_user $username;
